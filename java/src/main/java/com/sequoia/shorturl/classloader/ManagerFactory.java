...
public class ManagerFactory {
    ...
    /** 要加载的类的 classpath */
    public static final String CLASS_PATH = "D:\\WorkSpace\\short-url\\target\\classes\\";

    /** 实现热加载的类的全名称(包名+类名 ) */
    public static final String MY_MANAGER = "com.sequoia.shorturl.classloader.TestApi";

    public static BaseApi getManager(String className) {
    ...
    private static void load(String className, long lastModified) {
        ...
        BaseApi manager = newInstance(loadClass);
     ...
     * @return
     */
    private static BaseApi newInstance(Class loadClass) {
        try {
            return (BaseApi)loadClass.getConstructor(new Class[] {}).newInstance(new Object[] {});
